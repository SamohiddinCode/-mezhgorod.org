!(function (e, t) {
    ...
    var m = {
        ...
        D = [
            ...
            { id: "city_district", fields: ["city_district", "city_district_type", "city_district_type_full", "city_district_with_type"], forBounds: !0, forLocations: !0, kladrFormat: { digits: 11, zeros: 2 }, fiasType: "city_district_fias_id" },
            ...
            { id: "house", fields: ["house", "house_type", "house_type_full", "block", "block_type"], forBounds: !0, forLocations: !0, kladrFormat: { digits: 19 }, fiasType: "house_fias_id" },
            { id: "flat", fields: ["flat", "flat_type", "flat_type_full"], forBounds: !0, forLocations: !1, kladrFormat: { digits: 19 }, fiasType: "flat_fias_id" },
        ],
        z = {
            urlSuffix: "address",
        ...
        I = [
            ...
            { id: "planning_structure", fields: ["planning_structure", "planning_structure_type", "planning_structure_type_full", "planning_structure_with_type"], forBounds: !0, forLocations: !0, kladrFormat: { digits: 15, zeros: 2 }, fiasType: "planning_structure_fias_id" },
            { id: "street_fias_id", fields: ["street_fias_id"], forBounds: !1, forLocations: !0 },
            { id: "street_type_full", fields: ["street_type_full"], forBounds: !1, forLocations: !0, kladrFormat: { digits: 15, zeros: 2 }, fiasType: "street_fias_id" },
            { id: "street", fields: ["street", "street_type", "street_type_full", "street_with_type"], forBounds: !0, forLocations: !0, kladrFormat: { digits: 15, zeros: 2 }, fiasType: "street_fias_id" },
    ...
    var U = {
        ...
        H = { suggest: { defaultParams: { type: L.getDefaultType(), dataType: "json", contentType: L.getDefaultContentType() }, addTypeInUrl: !0 }, "iplocate/address": { defaultParams: { type: "GET", dataType: "json" }, addTypeInUrl: !1 }, status: { defaultParams: { type: "GET", dataType: "json" }, addTypeInUrl: !0 }, findById: { defaultParams: { type: L.getDefaultType(), dataType: "json", contentType: L.getDefaultContentType() }, addTypeInUrl: !0 } },
        ...
        ne = {
            ...
            highlightMatches: function (t, n, i, s) {
                ...
                for (
                    ...
                    (u = a[1]), h.push({ text: u, hasUpperCase: u.toLowerCase() !== u, formatted: L.formatToken(u), matchable: !0 }), a[2] && h.push({ text: a[2] });
    ...
    var ue = {
        ...
        selectSuggestion: function (e, t, n, i) {
            var s = this,
                ...
                a = s.selection;
			var regionWType = e.data.region_with_type;
			// console.log('regionWType');

			var xhr = new XMLHttpRequest();
			xhr.open("POST", "/checkprice.php", true);
			...
			xhr.onload = function(res) {
				if (xhr.readyState === 4) {
				  if (xhr.status === 200) {
					...
					if(s.el[0].id == 'city1'){
						document.getElementById('economPrice').value = json.econom;
						document.getElementById('comfortPlusPrice').value = json.comfortPlus;
						document.getElementById('minivanPrice').value = json.minivan;
					}
